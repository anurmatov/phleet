...
| Any | Codex + hosted DeepSeek / GLM | ⚠️ A `deepseek/` or `openrouter/` model prefix runs through a loopback adapter inside the agent. Unit-tested; the live vendor probe and canary are pending. See `docs/providers/codex-hosted-models.md` |
