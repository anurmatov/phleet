...
public sealed class TelegramOptions
{
    ...
    /// <summary>Base URL of the fleet-telegram service for internal message ring-buffer recording. Empty = disabled.</summary>
    public string FleetTelegramBaseUrl { get; set; } = "http://fleet-telegram:3800";
}
